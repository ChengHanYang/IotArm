...
<html lang="zh-hant"> <!-- lang網頁的語系 -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=0, shrink-to-fit=no">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags 相容性-->
    <meta name="description" content="iotforSG90"> <!--內容的主要描述-->
    <meta name="author" content="hywen"> <!--本網頁作者-->
    ...
    <style>
        body {
            margin: 0;  
            font-family: Microsoft JhengHei, "Helvetica Neue", Helvetica, Arial, sans-serif; <!--字型-->
            font-size: 14px;
            line-height: 20px;  <!--字體高度-->
            color: #333333;
...
<div class="jumbotron">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <p>看看您的監控設備吧:</p>
                <img src="<?= $streamer; ?>" class="img-thumbnail"> <!--php echo $streamer -->
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                <div class="offset-md-2 col-md-10 offset-xs-2 col-xs-10" style="padding-left: 3px;">
                    <p>
                        <a class="btn btn-danger arrow" arrow="up" href="javascript:void()" aria-label="up"> <!--javascript:void() 讓超連結不生效 , 當按鈕按下到oneclick.js-->
